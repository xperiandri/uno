...
namespace Windows.UI.Xaml.Controls
{
    ...
    (DebugTrace(XCP_TRACE_OUTPUT_MSG /*traceType*/, "CMH[0x%p]: OnPointerExited - handled=%d, parentIsSubMenu=%d.", this, handled, parentIsSubMenu));
        ...
        (DebugTrace(XCP_TRACE_OUTPUT_MSG /*traceType*/, "CMH[0x%p]: OnPointerExited - Stopping m_delayOpenMenuTimer.", this));
			...
			var ownerAsUIE = m_wpOwner.Target as UIElement;
			...
			if (!handled && ownerAsUIE != null && ownerAsUIE.IsLoaded)
			{
				...
				if (PointerDeviceType.Mouse == pointerDeviceType && !parentIsSubMenu)
				{
					...
					if (subMenuPresenterAsUIE != null)
					{
						...
						pointerPoint = args.GetCurrentPoint(null);
						point = (pointerPoint.Position);

						var elements = VisualTreeHelper.FindAllElementsInHostCoordinatesPointStatic(point, ownerAsUIE, true /* includeAllElements */);
						...
						{
							elements = VisualTreeHelper.FindAllElementsInHostCoordinatesPointStatic(point, subMenuPresenterAsUIE, true /* includeAllElements */);
    ...
    (DebugTrace(XCP_TRACE_OUTPUT_MSG /*traceType*/, "CMH[0x%p]: DelayCloseMenuTimerTickHandler.", this));
		...
		void EnsureCloseExistingSubItems()
		{
			...
			ISubMenuOwner ownerAsSubMenuOwner = m_wpOwner as ISubMenuOwner;
    ...
    (DebugTrace(XCP_TRACE_OUTPUT_MSG /*traceType*/, "CMH[0x%p]: CloseSubMenu.", this));
			...
			ISubMenuOwner owner  = m_wpOwner as ISubMenuOwner;
		...
		void OnIsEnabledChanged()
		{
			...
			if (ownerAsControl != null)
			{
				...
				{
					// UNO TODO
					// Control.UpdateVisualState(ownerAsControl, true /* useTransitions */);
				}
			}
		...
		void OnVisibilityChanged()
		{
			...
			if (ownerAsUIE != null)
			{
				...
				visibility = ownerAsUIE.Visibility;
			...
			Controls.Popup popup)
		{
			...
			if (ownerAsControl != null && ownerAsSubMenuOwner != null)
			{
				Size newPresenterSize = default;
				newPresenterSize = args.NewSize;
				...
				maxWidth = (presenterAsControl.MaxWidth);
				maxHeight = (presenterAsControl.MaxHeight);

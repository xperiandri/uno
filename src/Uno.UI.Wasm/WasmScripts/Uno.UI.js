    ...
    (function (UI) {
        class WindowManager {
            ...
            */
                ...
                if (eventName == "pointerenter") {
                    ...
                    const focusEventHandler = (event) => {
                        if (event.currentTarget.getAttribute("XamlIsFocusable") == "true") {
                            ...
                            console.log(`focus: allow for [${event.currentTarget}/${event.currentTarget && event.currentTarget.id}/${xamlFocusable}], restore to [${event.relatedTarget}/${event.relatedTarget && event.relatedTarget.id}]`);
                            event.preventDefault();
            ...
            setFocusable(viewId, isFocusable) {
                this.setFocusableInternal(Number(viewId), isFocusable);
                return "oks";
            }
            setFocusableNative(pParams) {
            ...
            setFocusableInternal(viewId, isFocusable) {
